...
private:
	...
	LCD::Layar<LayarClassicSize::Small> lastTimeLayar{ {ContentXOffset, 16 * TitleSize + GapSize + (16 * TextSize + GapSize) * 2},Vector2s{(short)LCD::ScreenSize.x, 16 * TextSize},3 };
