...
private:
	...
	constexpr static unsigned char SettingSize = 8;
	...
	const char* SettingName[SettingSize] = { socBuffer, "flash size:"   CONFIG_ESPTOOLPY_FLASHSIZE, ramBuffer, psramBuffer, "", "print to uart", "", nullptr };
