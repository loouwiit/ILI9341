...
private:
	...
	LCD::Text applicationText[2]{
		{offset + Vector2us{(blockSize + gapSize) * 0,0} + Vector2us{blockSize / 2, blockSize}, "touch", textSize},
		{offset + Vector2us{(blockSize + gapSize) * 1,0} + Vector2us{blockSize / 2, blockSize}, "clock", textSize}
	};
